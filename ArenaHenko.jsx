...
// Configuração da Galeria Estática - Lendo da sua pasta public/acdc-2802
...
const App = () => {
  ...
  return (
    <div className="font-sans text-white bg-black animate-fadeIn overflow-x-hidden scroll-smooth font-bold">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-12">
            {nextMatch && (
              <div onClick={() => window.open(getWaLink(`Interesse no jogo ${nextMatch.home} x ${nextMatch.away}`))} className="bg-white/5 backdrop-blur-md border border-white/10 p-5 rounded-3xl flex items-center gap-5 cursor-pointer text-left shadow-2xl font-black">
                ...
                <div className="flex-1 font-black"><p className="text-red-500 text-[10px] font-bold uppercase tracking-widest mb-1 font-black font-black font-black"><Zap className="w-3 h-3 inline mr-1 fill-red-500 font-black" /> Próximo Jogo</p><h3 className="text-base font-bold uppercase truncate text-white font-black">{nextMatch.home} x {nextMatch.away}</h3><div className="text-gray-500 text-[10px] font-mono">{timeLeft.d}d {timeLeft.h}h {timeLeft.m}m</div></div>
              </div>
            )}
            <div onClick={() => window.open(getWaLink(`Interesse oficial no show do ${nextEvent.name}`))} className="bg-white/5 backdrop-blur-md border border-white/10 p-5 rounded-3xl flex items-center gap-5 hover:bg-white/10 transition-all cursor-pointer text-left group shadow-2xl font-black">
              ...
              <div className="flex-1 text-white font-black font-black"><p className="text-gray-400 text-[10px] font-black uppercase tracking-widest mb-1">Próximo Evento</p><h3 className="text-base font-black uppercase leading-none">{nextEvent.name}</h3><p className="text-red-600 text-[9px] font-mono mt-1 font-black">{nextEvent.date}</p></div>
            </div>
          </div>
      ...
      <section id="sobre" className="py-24 px-6 bg-neutral-950 border-y border-neutral-900 font-black text-center sm:text-left font-black">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className="font-black">
            ...
            <h2 className="text-5xl font-black uppercase mb-8 italic text-white font-black">Onde a emoção <br/>encontra o luxo.</h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 font-black font-black font-black">
              <div><div className="flex items-center gap-1 mb-1 justify-center sm:justify-start font-black font-black"><span className="text-4xl font-black text-emerald-500">4.9</span><Star className="w-5 h-5 text-emerald-500 fill-emerald-500" /></div><p className="text-[9px] uppercase tracking-widest text-gray-500 font-black">Google Rating</p></div>
          ...
          <div className="grid gap-4">
             <div className="bg-neutral-900/40 p-6 rounded-2xl border border-neutral-800 flex gap-4 items-start shadow-xl group font-black">
                ...
                <div className="font-black">
                    <h4 className="text-sm font-black uppercase italic text-white font-black font-black">Operação Oficial</h4>
                    <p className="text-gray-500 text-xs mt-1 font-normal font-black font-black">Tratativa direta com o camarote. Sem intermediários ou riscos.</p>
                </div>
             </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-black border-y border-white/5 px-6 font-black text-center font-black">
          <div className="max-w-6xl mx-auto font-black font-black font-black">
            ...
            <div className="grid md:grid-cols-3 gap-8 font-black font-black">
                <div className="bg-neutral-900/30 p-8 rounded-3xl border border-white/5 font-black font-black"><MousePointerClick className="w-8 h-8 mx-auto mb-6 text-emerald-500 font-black font-black font-black" /><h4 className="text-xs uppercase tracking-widest mb-4 font-black">1. Reserve</h4><p className="text-gray-500 text-xs font-normal">Fale com o consultor oficial via WhatsApp.</p></div>
                <div className="bg-neutral-900/30 p-8 rounded-3xl border border-white/5 font-black font-black"><Smartphone className="w-8 h-8 mx-auto mb-6 text-emerald-500 font-black font-black" /><h4 className="text-xs uppercase tracking-widest mb-4 font-black">2. Receba</h4><p className="text-gray-500 text-xs font-normal font-normal">Bilhete via App oficial SPFC.</p></div>
                <div className="bg-neutral-900/30 p-8 rounded-3xl border border-white/5 font-black font-black"><UserCheck className="w-8 h-8 mx-auto mb-6 text-emerald-500 font-black font-black" /><h4 className="text-xs uppercase tracking-widest mb-4 font-black">3. Aproveite</h4><p className="text-gray-500 text-xs font-normal font-normal font-normal font-normal">Recepção VIP pela nossa equipe.</p></div>
            </div>
          </div>
      </section>
                 ...
                 <div key={i} className={`absolute w-full transition-all duration-1000 transform ${i === currentReviewIndex ? 'opacity-100 scale-100' : 'opacity-0 scale-90 pointer-events-none'} font-black font-black`}>
                    <div className="bg-neutral-900 p-10 md:p-14 rounded-[3.5rem] border border-neutral-800 shadow-2xl relative font-black font-black">
                       ...
                       <div className="flex items-center justify-center gap-5 font-black font-black">
                          ...
                          <div className="text-left font-black font-black font-black"><p className="uppercase text-sm italic font-black font-black">{r.name}</p><p className="text-gray-600 text-[10px] uppercase tracking-widest font-black">{r.role}</p></div>
                       </div>
                    </div>
                 </div>
               ))}
        ...
        <div key={activeSportId} className="max-w-6xl mx-auto bg-neutral-900/20 rounded-[3rem] p-8 md:p-16 border border-neutral-800 shadow-3xl animate-smooth font-black font-black">
            <div className="grid lg:grid-cols-5 gap-12 items-center font-black">
                ...
                <div className="lg:col-span-3 space-y-4 font-black">
                        ...
                        {expandedMatchKey === i && (
                           <div className="px-10 pb-10 pt-4 bg-white/5 border-t border-white/5 text-white animate-smooth font-black font-black">
                              <div className="grid grid-cols-2 gap-4 mb-8 text-[9px] uppercase tracking-widest font-black font-black">
                                  <div className="flex items-center gap-2 font-black font-black font-black"><Clock className="w-3 h-3 text-red-600 font-black font-black font-black" /> {m.time}</div>
                                  <div className="flex items-center gap-2 font-black font-black font-black font-black font-black"><Wine className="w-3 h-3 text-red-600 font-black font-black font-black" /> Open Bar</div>
                                  <div className="flex items-center gap-2 font-black font-black font-black font-black font-black"><Coffee className="w-3 h-3 text-red-600 font-black font-black font-black" /> Open Food</div>
                                  <div className="flex items-center gap-2 font-black font-black font-black font-black font-black"><Award className="w-3 h-3 text-red-600 font-black font-black font-black" /> VIP</div>
                              </div>
                    ...
                    )) : <p className="text-center text-gray-700 py-16 uppercase text-[10px] font-normal font-black font-black">Novas datas em breve.</p>}
                </div>
            </div>
        </div>
      </section>

      {/* Mega Eventos - RESTAURADO */}
      <section id="eventos" className="py-24 px-6 bg-black font-black font-black font-black">
        <div className="max-w-7xl mx-auto font-black font-black">
          <h2 className="text-4xl md:text-6xl font-black uppercase text-center mb-20 italic text-white font-black font-black font-black">Mega <span className="text-red-600 font-black font-black font-black font-black font-black">Eventos</span></h2>
          <div className="grid md:grid-cols-2 gap-12 font-black font-black font-black">
            {SHOWS_DATA.map((show, i) => (
              <div key={i} className="group flex flex-col font-black font-black font-black">
                <div className="relative h-[420px] rounded-[3rem] overflow-hidden mb-8 border border-neutral-800 group-hover:border-red-600 transition-all duration-700 shadow-2xl bg-neutral-900 font-black font-black font-black"><img src={show.image} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 scale-105 group-hover:scale-110 font-black" alt={show.name} /></div>
      ...
      {/* Experiência */}
      <section id="servicos" className="py-24 px-6 bg-neutral-950 border-t border-white/5 font-black text-center font-black font-black font-black">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-10 font-black font-black font-black font-black">
          {SERVICES_DATA.map((s, i) => (
            <div key={i} className="group relative h-[450px] rounded-[2.5rem] overflow-hidden border border-neutral-800 hover:border-red-600/50 transition-all duration-700 shadow-2xl font-black font-black font-black font-black font-black">
              <div className="absolute inset-0 font-black font-black font-black font-black font-black"><img src={s.imageUrl} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 font-black font-black" alt={s.title} /></div>
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent font-black font-black font-black font-black" />
              <div className="relative z-20 h-full p-10 flex flex-col justify-end text-left font-black font-black">
                ...
                <p className="text-gray-300 text-sm font-normal leading-tight font-normal font-normal font-black font-black font-black">{s.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section id="galeria" className="py-24 px-6 bg-black border-y border-white/5 font-black text-center font-black font-black font-black">
        <div className="max-w-7xl mx-auto font-black font-black font-black font-black font-black">
          <div className="flex flex-col items-center justify-center mb-16 gap-4 font-black font-black font-black font-black font-black">
            <h2 className="text-4xl md:text-6xl font-black uppercase italic text-white font-black font-black">Nossa <span className="text-red-600 font-black font-black">Galeria</span></h2>
            <p className="text-gray-500 uppercase text-[10px] tracking-widest font-black">
              {isAlbumOpen ? `Explorando: ${currentAlbum.name}` : 'Selecione uma pasta para visualizar'}
            </p>
            {isAlbumOpen && (
              <button 
                onClick={() => setIsAlbumOpen(false)}
                className="mt-4 flex items-center gap-2 text-red-500 hover:text-white transition-colors uppercase text-[10px] font-black font-black font-black font-black"
              >
            ...
            {!isAlbumOpen ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-smooth font-black font-black font-black">
                {STATIC_GALLERY.map((album) => (
                  ...
                  >
                    <div className="absolute inset-0 font-black font-black font-black">
                      <img 
                        src={album.cover} 
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-80 font-black font-black font-black font-black" />
                    <div className="absolute bottom-10 left-10 text-left font-black font-black font-black font-black font-black">
                       <div className="bg-red-600 px-4 py-1 rounded-full text-[8px] w-fit mb-3 uppercase font-black font-black font-black">Pasta</div>
                       <h3 className="text-2xl italic uppercase font-black font-black font-black">{album.name}</h3>
                       <p className="text-gray-400 text-[10px] mt-1 uppercase font-black font-black font-black font-black">{album.photos.length} Fotos</p>
                    </div>
                  </div>
                ))}
              </div>
            ) : (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 animate-smooth font-black font-black font-black font-black">
                {currentAlbum.photos.map((photoName, idx) => (
                  <div key={idx} className="group relative aspect-square rounded-[2rem] overflow-hidden border border-white/5 bg-neutral-900 shadow-xl font-black font-black font-black">
                    <img 
                      ...
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 font-black font-black" 
                      alt="Evento" 
                      onError={(e) => { e.target.src = 'https://via.placeholder.com/400x400?text=Erro+Imagem'; }}
                    />
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3 font-black font-black">
          ...
          <div className="flex animate-infinite-scroll whitespace-nowrap gap-28 items-center font-black">
            {[...PARTNERS_DATA, ...PARTNERS_DATA].map((p, i) => (
                <div key={i} className="flex-shrink-0 flex items-center justify-center w-64 h-24 transition-all duration-500 font-black font-black">
                    <img src={p.logoUrl} className="object-contain font-black" alt={p.name} style={{ maxHeight: '70px', maxWidth: '220px', transform: `scale(${p.scale || 1.0})`, filter: p.invert ? 'brightness(0) invert(1)' : 'none' }} />
                </div>
            ))}
          </div>
        </div>
      ...
      <section id="faq" className="py-24 px-6 bg-black border-t border-white/5 font-black text-white text-center font-black font-black">
        <div className="max-w-3xl mx-auto font-black font-black">
            <h2 className="text-4xl font-black uppercase mb-16 italic font-black font-black font-black">Dúvidas <span className="text-red-600 font-black font-black font-black font-black">Frequentes</span></h2>
            <div className="space-y-4 font-black font-black font-black">
                {FAQ_DATA.map((item, i) => (
                    <div key={i} className="bg-neutral-900/50 border border-neutral-800 rounded-2xl overflow-hidden text-left transition-all font-black font-black font-black">
                        <button onClick={() => setExpandedFaqKey(expandedFaqKey === i ? null : i)} className="w-full p-6 flex items-center justify-between font-black uppercase text-[10px] tracking-widest group font-black font-black font-black font-black font-black font-black font-black">{item.q}<ChevronDown className={`w-4 h-4 text-gray-600 transition-transform ${expandedFaqKey === i ? 'rotate-180' : ''} font-black font-black font-black`} /></button>
      ...
      {/* Footer */}
      <footer id="contato" className="py-32 bg-neutral-950 border-t border-neutral-900 text-center font-black font-black font-black">
        <h2 className="text-5xl md:text-7xl font-black mb-20 uppercase italic text-white font-black font-black font-black font-black">Viva sua <br/><span className="text-red-600 font-black font-black font-black font-black font-black font-black">ARENA HENKO.</span></h2>
      ...
      {/* Login Modal */}
      {isLoginModalOpen && (
        <div className="fixed inset-0 z-[300] bg-black/95 backdrop-blur-2xl flex items-center justify-center p-8 font-black font-black font-black font-black">
          <div className="bg-neutral-900 border border-neutral-800 p-12 rounded-[3rem] w-full max-w-sm shadow-3xl text-center font-black font-black font-black font-black font-black font-black">
            <h2 className="text-xl uppercase mb-8 italic text-white font-black font-black font-black font-black font-black">Painel <span className="text-red-600 font-black font-black font-black font-black font-black">Admin</span></h2>
            <form onSubmit={handleAdminLogin}>
              <input 
                ...
                className="w-full bg-black border border-neutral-800 rounded-2xl px-8 py-5 mb-6 text-white focus:outline-none focus:border-red-600 text-center tracking-widest font-black font-black font-black font-black font-black" 
              />
              <div className="flex gap-4">
                <button type="button" onClick={() => setIsLoginModalOpen(false)} className="flex-1 py-4 text-[10px] uppercase border border-neutral-800 rounded-2xl font-black font-black font-black font-black font-black font-black font-black font-black font-black">Voltar</button>
                <button type="submit" className="flex-1 py-4 text-[10px] uppercase bg-red-600 rounded-2xl text-white font-black font-black font-black font-black font-black font-black font-black font-black">Entrar</button>
              </div>
            </form>
          </div>
        </div>
      )}
      {toast && <div className="fixed bottom-12 left-1/2 -translate-x-1/2 z-[500] bg-red-600 text-white px-10 py-4 rounded-full font-black text-[10px] uppercase tracking-widest animate-bounce flex items-center gap-2 font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black"><AlertTriangle className="w-4 h-4 font-black" /> {toast}</div>}
    </div>
  );
};
