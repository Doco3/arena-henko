...
const SPORT_DATA = [
  ...
  { 
    id: 4, name: 'Copa do Brasil', subtitle: 'CBF 2026', image: 'https://upload.wikimedia.org/wikipedia/pt/9/96/CopaDoBrasil.png', 
    matches: [
...
const SHOWS_DATA = [
  { id: 'bts-tour', name: 'BTS - ARIRANG TOUR', date: '12/11/2026', image: BTS_BANNER_URL, desc: 'O maior fenómeno cultural do planeta regressa ao Morumbis após o hiato militar.' },
  { id: 'show1', name: 'The Weeknd', date: '30/04/2026', image: 'https://i.imgur.com/1zpCq3e.jpg', desc: 'Uma experiência visual e sonora imersiva com a melhor vista do Morumbis.' },
  { id: 'show2', name: 'Festa do Peão', date: '20/08/2026', image: 'https://i.imgur.com/GW8we0X.png', desc: 'Hospitalidade Arena Henko presente no maior evento sertanejo do país.' },
  { id: 'show3', name: 'Harry Styles', date: '18/07/2026', image: 'https://imgur.com/JbcYLor.jpg', desc: 'Tour Together, Together - A experiência definitiva no Camarote Arena Henko.' },
];
...
const BTSCountdown = () => {
  ...
  const Item = ({ value, label }) => (
    <div className="flex flex-col items-center">
      <div className="bg-black/30 backdrop-blur-md border border-white/10 w-12 h-12 md:w-16 md:h-16 rounded-xl flex items-center justify-center mb-1">
        <span className="text-lg md:text-xl font-black italic">{String(value).padStart(2, '0')}</span>
      </div>
      <span className="text-[9px] uppercase tracking-widest font-black opacity-40">{label}</span>
    </div>
  );

  return (
    <div className="flex gap-3 md:gap-4">
      <Item value={timeLeft.days} label="Dias" />
  ...
  return (
    <div className="font-sans text-white bg-black animate-fadeIn overflow-x-hidden scroll-smooth font-black italic">
      <style>{`
        ...
        .bts-hero-overlay { background: linear-gradient(to bottom, rgba(0, 0, 0, 0.8) 0%, rgba(0, 0, 0, 0) 25%, rgba(0, 0, 0, 0) 75%, rgba(0, 0, 0, 0.9) 100%); }
        .drawer-content { max-height: 0; opacity: 0; overflow: hidden; transition: all 0.7s cubic-bezier(0.4, 0, 0.2, 1); }
      ...
      <nav className="fixed top-0 w-full z-[100] bg-black/40 backdrop-blur-md border-b border-white/5 py-4 px-8 flex justify-between items-center font-black">
        <div className="cursor-pointer" onClick={() => window.scrollTo({top:0, behavior:'smooth'})}>
          <img src={LOGO_URL} alt="Logo" className="h-10 md:h-12 w-auto object-contain transition-transform hover:scale-105" />
        </div>
        <div className="hidden lg:flex items-center gap-10 uppercase text-[11px] tracking-[0.2em] text-white">
      ...
      <section className="relative h-screen flex flex-col justify-between bg-black overflow-hidden border-b border-white/5">
        <div className="absolute inset-0 z-0">
          <img 
            src={BTS_BANNER_URL} 
            className="w-full h-full object-cover object-top lg:object-center opacity-90 scale-100 transition-transform duration-[10s] hover:scale-110" 
            alt="BTS Members" 
          />
          <div className="absolute inset-0 bts-hero-overlay z-10" />
        </div>

        {/* TOP: Título Reduzido e Posicionado para não tampar faces */}
        <div className="relative z-20 w-full max-w-7xl mx-auto px-10 pt-28 animate-smooth">
            <div className="flex flex-col items-center lg:items-start">
                <h1 className="text-3xl md:text-5xl lg:text-6xl font-black uppercase tracking-tighter leading-tight text-white drop-shadow-2xl">
                  BTS WORLD TOUR <br className="lg:hidden" /> - ARIRANG
                </h1>
                <div className="flex items-center gap-4 mt-2">
                    <p className="text-lg md:text-xl font-black uppercase tracking-[0.3em] text-red-600 italic">MORUMBIS</p>
        ...
        {/* BOTTOM: Ações e Info do Camarote na base absoluta */}
        <div className="relative z-20 w-full max-w-7xl mx-auto px-10 pb-12 flex flex-col lg:flex-row items-center lg:items-end justify-between gap-8">
            ...
            <div className="flex flex-col items-center lg:items-end gap-5 w-full lg:w-auto">
                <div className="flex flex-col items-center lg:items-end text-center lg:text-right">
                    <p className="text-white text-[10px] uppercase tracking-[0.3em] font-black mb-1 opacity-50 italic">PRÉ-VENDA ARENA:</p>
                    <BTSCountdown />
                </div>

                <button 
                  onClick={() => window.open(getWaLink("QUERO ENTRAR NA LISTA DE PRÉ-VENDA EXCLUSIVA DO BTS - CAMAROTE ARENA HENKO"))}
                ...
                <div className="text-white/80 text-sm md:text-base font-normal leading-relaxed italic text-left p-8 md:p-12 bg-neutral-900 rounded-[3rem] border border-white/5 shadow-2xl mt-6">
                    <div className="grid md:grid-cols-2 gap-12">
                        <div className="space-y-6">
                            ...
                            <p>O BTS não é apenas o maior grupo de K-Pop, mas a maior força cultural do planeta nesta década. Formado por RM, Jin, Suga, J-Hope, Jimin, V e Jungkook, conquistaram o topo da Billboard dezenas de vezes e possuem a fanbase mais apaixonada do mundo: o ARMY.</p>
                            ...
                            <p>A conexão com o Brasil é lendária. Em 2019, na tour 'Speak Yourself', pararam o país com dois Allianz Parque lotados em minutos. O retorno em 2026 no Morumbis será o evento da década.</p>
                        </div>
                        <div className="space-y-6">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid gap-4">
             <div className="bg-neutral-900/40 p-10 rounded-[3rem] border border-neutral-800 flex gap-6 items-start shadow-xl group hover:border-red-600/50 transition-all font-black">
                ...
                <div><h4 className="text-lg font-black uppercase italic text-white font-black font-black font-black font-black">Operação Oficial</h4><p className="text-gray-500 text-sm mt-2 font-normal italic font-black font-black font-black font-black font-black">Tratativa direta com o camarote. Sem intermediários.</p></div>
             </div>
          </div>
        </div>
      </section>
      ...
      <section id="reviews" className="py-24 bg-black border-y border-white/5 font-black text-center italic">
      ...
      <section id="calendario" className="py-24 px-6 bg-neutral-950 font-black text-white italic font-black">
        <h2 className="text-4xl md:text-6xl font-black uppercase text-center mb-16 italic font-black">Agenda <span className="text-red-600 font-black">2026</span></h2>
            ...
            <div className="grid lg:grid-cols-5 gap-12 items-center font-black">
                <div className="lg:col-span-2 text-center font-black">
                    <div className="bg-black w-32 h-32 mx-auto rounded-3xl p-6 border border-neutral-800 flex items-center justify-center mb-6 overflow-hidden font-black">
                      <ImageWithFallback src={selectedSport.image} alt="League Logo" className="max-h-full object-contain font-black" />
                    </div>
                    ...
                    <div key={m.id} className={`bg-neutral-950 border transition-all duration-300 rounded-[2.5rem] overflow-hidden ${expandedMatchKey === m.id ? 'border-red-600 shadow-2xl bg-neutral-900' : 'border-neutral-800 hover:border-neutral-700 font-black'}`}>
                        ...
                        <div className={`drawer-content ${expandedMatchKey === m.id ? 'drawer-open px-8 pb-8' : ''}`}>
                             <div className="pt-4 border-t border-white/5 grid grid-cols-2 gap-4 text-left font-black">
                                <div><p className="text-[10px] text-gray-500 uppercase tracking-widest font-black font-black">Horário / Local</p><p className="text-sm font-black text-white font-black">{m.time} • Estádio do Morumbis</p></div>
                                <div className="text-right"><p className="text-[10px] text-gray-500 uppercase tracking-widest font-black font-black">Hospitalidade</p><p className="text-sm font-black text-emerald-500 uppercase font-black">Full Open Bar & Food</p></div>
      ...
      {/* Outros Mega Eventos (RESTAURADOS) */}
      <section id="eventos" className="py-24 px-6 bg-black font-black text-center italic">
        <div className="max-w-7xl mx-auto font-black">
          <h2 className="text-4xl md:text-6xl font-black uppercase mb-20 italic text-white font-black font-black">Mega <span className="text-red-600 font-black">Eventos</span></h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-12 font-black font-black">
            {SHOWS_DATA.map((show) => (
              <div key={show.id} className="group flex flex-col text-left font-black">
                <div className="relative h-[450px] rounded-[3.5rem] overflow-hidden mb-8 border border-neutral-800 group-hover:border-red-600 transition-all duration-700 shadow-2xl bg-neutral-900 font-black">
                ...
                <span className="text-red-600 text-[11px] font-black uppercase tracking-[0.4em] mb-3 block font-black italic">{show.date}</span>
                <h3 className="text-4xl font-black uppercase mb-4 italic text-white leading-none font-black">{show.name}</h3>
                <p className="text-gray-500 text-base font-normal mb-8 leading-relaxed italic font-black">{show.desc}</p>
                <button onClick={() => window.open(getWaLink(`Interesse oficial no evento ${show.name}.`))} className="text-[11px] font-black uppercase tracking-widest flex items-center gap-3 text-white hover:text-red-600 transition-colors font-black"><ArrowRight size={18} /> Ver Disponibilidade</button>
              </div>
            ))}
          </div>
        </div>
          ...
          {!isAlbumOpen ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-smooth font-black font-black">
              {STATIC_GALLERY.map((album) => (
                <div key={album.id} onClick={() => { setActiveAlbumId(album.id); setIsAlbumOpen(true); }} className="group cursor-pointer relative overflow-hidden rounded-[3rem] aspect-[4/3] border border-white/10 bg-neutral-900 shadow-2xl font-black font-black">
                  <div className="absolute inset-0 font-black">
                    <img src={album.cover} className="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-all duration-700 font-black" alt={album.name} />
                  </div>
                  ...
                  <div className="absolute bottom-10 left-10 text-left font-black font-black font-black">
                     ...
                     <p className="text-gray-400 text-[10px] mt-1 uppercase font-black opacity-60 font-black font-black">{album.photos.length} Fotos</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 animate-smooth font-black">
              {[...Array(8)].map((_, idx) => (
                <div key={idx} className="group relative aspect-square rounded-[2rem] overflow-hidden border border-white/5 bg-neutral-900 shadow-xl font-black font-black">
      ...
      {/* Footer */}
      <footer id="contato" className="py-32 bg-neutral-950 border-t border-neutral-900 text-center font-black italic">
        <h2 className="text-5xl md:text-7xl font-black mb-20 uppercase italic text-white leading-none font-black font-black font-black">VIVA SUA <br/><span className="text-red-600 font-black font-black font-black">ARENA HENKO.</span></h2>
