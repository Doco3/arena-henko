...
const appId = typeof __app_id !== 'undefined' ? __app_id : 'arena-henko-official-v2';
...
const App = () => {
  ...
  // Data Sync - Only when user is authed
  useEffect(() => {
    if (!user || !db) return;
    ...
    <div className="animate-fadeIn">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-2xl mx-auto relative z-20">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <h3 className="text-sm font-bold text-white uppercase truncate mb-1">{nextMatch.home} x {nextMatch.away}</h3>
                          </div>
              ...
              <button onClick={() => window.open(getWaLink(`Tenho interesse nos shows da Arena Henko`))} className="bg-neutral-900/80 backdrop-blur-md border border-neutral-800 p-4 rounded-2xl flex items-center gap-4 hover:border-red-600 transition-all group text-left w-full text-white">
                  ...
                  <div className="flex-1 min-w-0">
                      ...
                      <h3 className="text-sm font-bold text-white uppercase truncate">{SHOWS_DATA[0].name}</h3>
      ...
      <section id="servicos" className="py-32 bg-neutral-900/30 px-4 text-white text-center">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl md:text-6xl font-bold uppercase mb-20 tracking-tighter text-white font-black">A Experiência Completa</h2>
      ...
      <section className="py-32 bg-neutral-900/30 px-4 text-white text-center text-white font-black font-black">
         <div className="max-w-7xl mx-auto">
            <h3 className="text-3xl font-black text-red-500 mb-16 uppercase tracking-[0.2em] text-red-500 font-bold font-black">Shows & Entretenimento</h3>
               ...
               {REVIEWS_DATA.map((r, i) => (
                  <div key={i} className="bg-neutral-950 p-10 rounded-[56px] border border-neutral-800 relative group hover:border-red-600/30 transition-all text-white font-black font-black font-black">
                     ...
                     <div className="flex items-center gap-4 text-white font-black font-black uppercase tracking-widest uppercase">
                        ...
                        <div><p className="text-white text-xs font-bold uppercase tracking-wider font-bold font-black font-black uppercase tracking-widest uppercase">{r.name}</p><p className="text-gray-600 text-[10px] font-bold uppercase font-bold font-black font-black uppercase tracking-widest uppercase">{r.role}</p></div>
                     </div>
                  </div>
               ))}
            </div>
      ...
      {/* Contato Original */}
      <section id="contato" className="py-40 bg-neutral-950 px-6 relative overflow-hidden text-white border-t border-neutral-900 text-center font-bold font-black uppercase tracking-widest uppercase">
        <div className="max-w-4xl mx-auto relative z-10 text-white font-bold font-bold font-bold font-black">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20 text-white font-bold font-bold font-bold font-black font-black font-black uppercase tracking-widest uppercase">
             <a href="https://instagram.com/arenahenko" target="_blank" rel="noreferrer" className="flex flex-col items-center p-10 bg-neutral-900/50 rounded-3xl border border-neutral-800 hover:border-red-600 group shadow-xl transition-all font-bold font-black font-black"><Instagram className="w-10 h-10 text-red-600 mb-6 group-hover:scale-110 transition-transform text-red-600 font-bold font-bold font-black font-black" /><span className="font-bold text-[11px] uppercase tracking-[0.2em] font-bold font-black font-black">Instagram</span></a>
             <a href="https://wa.me/5511940741355" target="_blank" rel="noreferrer" className="flex flex-col items-center p-10 bg-neutral-900/50 rounded-3xl border border-neutral-800 hover:border-red-600 group shadow-xl transition-all text-white font-bold font-bold font-bold font-black font-black font-black uppercase tracking-widest uppercase"><Phone className="w-10 h-10 text-red-600 mb-6 group-hover:scale-110 transition-transform text-red-600 font-bold font-bold font-black font-black" /><span className="font-bold text-[11px] uppercase tracking-[0.2em] font-bold font-black font-black">WhatsApp</span></a>
             <a href="mailto:sergio@henkoproducoes.com.br" className="flex flex-col items-center p-10 bg-neutral-900/50 rounded-3xl border border-neutral-800 hover:border-red-600 group shadow-xl transition-all text-white font-bold font-bold font-bold font-black font-black font-black uppercase tracking-widest uppercase"><Mail className="w-10 h-10 text-red-600 mb-6 group-hover:scale-110 transition-transform text-red-600 font-bold font-bold font-black font-black" /><span className="font-bold text-[11px] uppercase tracking-[0.2em] font-bold font-black font-black">E-mail</span></a>
          </div>
        </div>
      </section>
      ...
      <footer className="py-24 border-t border-neutral-900 opacity-50 text-white text-center relative text-white font-bold font-bold font-bold font-bold font-bold font-bold font-black">
        <div className="absolute bottom-6 right-6 opacity-20 hover:opacity-100 transition-opacity cursor-pointer p-4 group text-white font-bold font-bold font-bold font-bold font-bold font-black font-black font-black uppercase tracking-widest uppercase">
           <LockKeyhole className="w-6 h-6 text-gray-500 group-hover:text-red-600 font-black font-black font-black" onClick={() => handleNavClick('admin')} />
        </div>
  ...
  const renderGallery = () => (
    <div className="pt-32 pb-20 px-4 min-h-screen bg-neutral-950 animate-fadeIn text-center text-white font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black">
      <div className="max-w-7xl mx-auto text-white font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black uppercase tracking-widest uppercase">
        <button onClick={() => handleNavClick('home', '#')} className="flex items-center gap-2 text-gray-500 hover:text-white transition-colors uppercase text-[10px] font-bold tracking-widest mb-10 mx-auto border border-neutral-800 px-10 py-5 rounded-full bg-neutral-900/50 shadow-xl hover:bg-neutral-800 text-gray-400 font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase"><ArrowLeft className="w-4 h-4 text-white font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase" /> Voltar para o Site</button>
        <h2 className="text-5xl md:text-8xl font-black uppercase tracking-tighter mb-10 text-white text-center font-bold uppercase font-bold uppercase tracking-widest uppercase font-bold font-bold font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase">Galeria da <span className="text-red-600 underline decoration-red-600/20 underline-offset-8 text-red-600 font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase">Torcida</span></h2>
        <div className="flex flex-wrap justify-center gap-2 mb-16 text-white text-center font-bold uppercase tracking-widest uppercase font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase">
            <button onClick={() => setGalleryFilter('Todos')} className={`px-6 py-3 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all ${galleryFilter === 'Todos' ? 'bg-red-600 text-white shadow-lg font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase' : 'bg-neutral-900 text-gray-500 hover:text-white font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase'}`}>Todos</button>
            {availableAlbums.filter(a => a !== 'Geral').map(album => (
              <button key={album} onClick={() => setGalleryFilter(album)} className={`px-6 py-3 rounded-full text-[10px] font-bold uppercase tracking-widest transition-all ${galleryFilter === album ? 'bg-red-600 text-white shadow-lg font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase' : 'bg-neutral-900 text-gray-500 hover:text-white font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase'}`}>{album}</button>
            ))}
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 text-white text-center font-bold uppercase tracking-widest uppercase font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase">
          {galleryPhotos.filter(p => galleryFilter === 'Todos' || p.album === galleryFilter).length > 0 ? galleryPhotos.filter(p => galleryFilter === 'Todos' || p.album === galleryFilter).map((photo) => (
            <div key={photo.id} className="aspect-[4/5] relative group overflow-hidden rounded-[56px] border border-neutral-800 bg-neutral-900 shadow-2xl transition-all hover:border-red-600/50 hover:-translate-y-3 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase">
              <img src={photo.image} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110 font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black" alt="Moment" />
              <div className="absolute inset-0 bg-gradient-to-t from-neutral-950 opacity-80 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black"></div>
              <div className="absolute top-4 right-4 z-20 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
                <button onClick={() => handleDownload(photo.image, `arena-henko-${photo.id}.jpg`)} className="bg-red-600 text-white p-3 rounded-full shadow-2xl hover:scale-110 transition-transform active:scale-95 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black"><Download className="w-5 h-5 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black" /></button>
              </div>
              <div className="absolute bottom-0 left-0 right-0 p-10 text-left text-white font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
                <span className="bg-red-600 text-white text-[8px] font-bold px-3 py-1.5 rounded-full uppercase tracking-widest mb-3 inline-block border border-red-500/30 backdrop-blur-sm font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">{photo.album || 'Geral'}</span>
                <p className="text-white text-lg font-bold uppercase tracking-tight font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">Arena Henko Master</p>
                <p className="text-gray-500 text-[10px] font-bold mt-1 uppercase tracking-widest font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">{new Date(photo.timestamp).toLocaleDateString()}</p>
              </div>
            </div>
          )) : (
            <div className="col-span-full py-40 border-2 border-dashed border-neutral-800 rounded-[5rem] flex flex-col items-center justify-center text-gray-600 bg-neutral-900/20 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
               <Camera className="w-20 h-20 mb-6 opacity-10 text-white font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black font-black" />
               <p className="text-2xl font-bold uppercase tracking-widest text-white font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">Álbum em Branco...</p>
            </div>
          )}
        </div>
      </div>
  ...
  const renderAdmin = () => (
    <div className="pt-32 pb-20 px-4 min-h-screen flex flex-col items-center bg-neutral-950 animate-fadeIn text-white text-center font-bold font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
       {!isAdminLoggedIn ? (
         <div className="bg-neutral-900 p-16 rounded-[60px] border border-neutral-800 max-w-md w-full text-center mt-20 shadow-3xl text-white font-bold text-center text-white font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black">
            <LockKeyhole className="w-20 h-20 text-red-600 mx-auto mb-10 animate-pulse text-red-600 font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black" />
            <h2 className="text-3xl font-bold uppercase mb-4 tracking-tighter text-white font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black">Acesso Master</h2>
            <form onSubmit={handleAdminLogin} className="flex flex-col gap-6 text-white text-center font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black">
               <input type="password" placeholder="SENHA" className="bg-neutral-950 border border-neutral-800 rounded-2xl px-6 py-6 text-white text-center font-bold outline-none focus:border-red-600 text-2xl tracking-widest transition-all placeholder:text-gray-800 text-white text-center font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black" value={adminInputPass} onChange={(e) => setAdminInputPass(e.target.value)} />
               <button type="submit" className="bg-red-600 text-white py-5 rounded-2xl font-black uppercase text-xs tracking-widest shadow-xl hover:bg-red-700 font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black">Entrar</button>
               {loginError && <p className="text-red-500 text-xs font-bold mt-2 animate-pulse font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black">{loginError}</p>}
            </form>
         </div>
       ) : (
         <div className="w-full max-w-7xl px-4 text-white text-center font-bold font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
            <div className="flex flex-col md:flex-row justify-between items-center mb-20 gap-8 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
                <button onClick={() => setIsAdminLoggedIn(false)} className="bg-neutral-800 text-gray-400 px-10 py-4 rounded-full font-bold uppercase text-[10px] hover:text-white transition-all shadow-xl font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black">Sair</button>
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-center bg-neutral-900 p-6 rounded-[32px] border border-neutral-800 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
                  <div className="flex flex-col gap-2 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
                    <label className="text-[9px] font-bold uppercase text-gray-500 tracking-widest text-left ml-2 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">Escolher Destino:</label>
                  ...
                  <div className="relative font-bold font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
                    <input type="file" accept="image/*" className="hidden" ref={fileInputRef} onChange={handleFileUpload} />
                    <button onClick={() => fileInputRef.current.click()} disabled={isUploading} className="bg-red-600 text-white px-8 py-4 rounded-2xl font-black uppercase text-xs tracking-widest shadow-2xl hover:scale-105 transition-all flex items-center gap-3 font-bold font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
                      {isUploading ? <Loader2 className="w-4 h-4 animate-spin font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black"/> : <Upload className="w-4 h-4 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black font-black"/>} Enviar Foto
                    </button>
                  </div>
                </div>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
              {galleryPhotos.map((photo) => (
                <div key={photo.id} className="relative aspect-square rounded-[48px] overflow-hidden group border border-neutral-800 bg-neutral-900 shadow-xl transition-all hover:border-red-600/50 font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
                   <img src={photo.image} className="w-full h-full object-cover opacity-50 font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black" alt="Admin" />
                   <div className="absolute top-2 left-2 bg-black/60 px-2 py-1 rounded-lg text-[8px] font-bold text-white uppercase tracking-tighter truncate max-w-[80%] font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">{photo.album || 'Geral'}</div>
                   <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
                      {deleteConfirmId === photo.id ? (
                        <div className="flex gap-2 font-bold font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black">
                           <button onClick={() => handleDeletePhoto(photo.id)} className="bg-red-600 text-white p-4 rounded-full border-2 border-white hover:scale-110 transition-all shadow-2xl text-white font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black"><Trash2 className="w-6 h-6 text-white font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black" /></button>
                           <button onClick={() => setDeleteConfirmId(null)} className="bg-neutral-800 text-white p-4 rounded-full border-2 border-white hover:scale-110 transition-all shadow-2xl text-white font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black"><X className="w-6 h-6 text-white font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black" /></button>
                        </div>
                      ) : (
                        <button onClick={() => setDeleteConfirmId(photo.id)} className="bg-red-600 text-white p-6 rounded-full border-4 border-neutral-950 shadow-2xl hover:scale-110 text-white font-bold text-white font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black"><Trash2 className="w-6 h-6 text-white font-bold font-bold font-bold font-bold font-bold font-bold font-bold font-bold uppercase tracking-widest uppercase font-black font-black font-black font-black font-black font-black font-black font-black uppercase tracking-widest uppercase font-black" /></button>
                      )}
                   </div>
                </div>
              ))}
  ...
  return (
    <div className="font-sans text-gray-100 bg-neutral-950 min-h-screen selection:bg-red-600 selection:text-white overflow-x-hidden text-center text-white">
      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 bg-neutral-950/80 backdrop-blur-md border-b ${scrolled ? 'border-neutral-800' : 'border-white/10'} h-20 flex justify-between items-center px-8 text-white`}>
        ...
        <div className="hidden md:flex space-x-10 items-center font-bold">
          {NAV_LINKS.map(n => (
            <button key={n.name} onClick={() => handleNavClick(n.view, n.href)} className={`text-[10px] font-bold uppercase tracking-widest transition-colors hover:text-red-500 ${currentView === n.view ? 'text-red-600' : 'text-gray-100'}`}>{n.name}</button>
          ))}
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-[1000] bg-neutral-950/98 backdrop-blur-3xl flex flex-col items-center justify-center space-y-10 md:hidden animate-fadeIn">
          <button onClick={() => setIsMenuOpen(false)} className="absolute top-8 right-8 text-white p-3 border border-neutral-800 rounded-full font-bold"><X className="w-10 h-10" /></button>
          {NAV_LINKS.map(n => (
      ...
      <footer className="py-24 border-t border-neutral-900 opacity-50 text-white text-center relative font-bold uppercase tracking-widest">
        ...
        <img src="https://i.imgur.com/cSYIvq6.png" className="h-10 mx-auto mb-10 grayscale opacity-30 text-white text-center text-white text-white font-bold uppercase tracking-widest" alt="Footer Logo" />
