  ...
  return (
    <div className="font-sans text-white bg-black animate-fadeIn overflow-x-hidden scroll-smooth font-black italic">
      <style>{`
        ...
        .bts-hero-overlay { background: linear-gradient(to bottom, rgba(0, 0, 0, 0.7) 0%, rgba(0, 0, 0, 0) 30%, rgba(0, 0, 0, 0) 70%, rgba(0, 0, 0, 0.9) 100%); }
      ...
      <nav className="fixed top-0 w-full z-[100] bg-black/40 backdrop-blur-md border-b border-white/5 py-4 px-8 flex justify-between items-center font-black">
        ...
        <div className="hidden lg:flex items-center gap-10 uppercase text-[11px] tracking-[0.2em] text-white/80 font-black">
            {NAV_LINKS.map(link => <a key={link.name} href={link.href} className="hover:text-red-600 transition-all font-black">{link.name}</a>)}
            <button onClick={() => setIsLoginModalOpen(true)} className="hover:text-red-600 transition-all opacity-20"><LockKeyhole size={16}/></button>
        </div>
      ...
      <section className="relative h-screen flex flex-col justify-between bg-black overflow-hidden border-b border-white/5 font-black">
        ...
        <div className="relative z-20 w-full max-w-7xl mx-auto px-10 pb-12 flex flex-col lg:flex-row items-center lg:items-end justify-between gap-8 font-black">
      ...
      <section className="bg-neutral-950 py-12 px-6 border-b border-white/5">
        <div className="max-w-4xl mx-auto flex flex-col items-center font-black">
            <button onClick={() => setExpandedBtsHistory(!expandedBtsHistory)} className="bg-neutral-900 border border-white/10 px-10 py-4 rounded-full text-[11px] text-white uppercase tracking-[0.3em] font-black flex items-center gap-3 hover:text-red-600 transition-all shadow-xl font-black">
                ...
                <div className="text-white/80 text-sm md:text-base font-normal leading-relaxed italic text-left p-8 md:p-12 bg-neutral-900 rounded-[3rem] border border-white/5 shadow-2xl mt-6 font-black">
                    <div className="grid md:grid-cols-2 gap-12">
                        <div className="space-y-6">
                            <div className="flex items-center gap-3 text-red-600 font-black font-black font-black"><Globe size={20}/><span className="uppercase tracking-widest text-xs font-black">Lendas Globais</span></div>
                            ...
                            <div className="flex items-center gap-3 text-red-600 font-black font-black font-black"><Flame size={20}/><span className="uppercase tracking-widest text-xs font-black">Legado no Brasil</span></div>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-3 text-emerald-500 font-black font-black font-black font-black"><TrendingUp size={20}/><span className="uppercase tracking-widest text-sm font-black">Arirang Tour 2026</span></div>
      ...
      <section className="bg-neutral-900/50 border-y border-white/5 py-12 font-black text-emerald-500 text-[10px] tracking-widest uppercase italic font-black text-center">
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-3 gap-12 font-black">
            <div className="flex flex-col items-center gap-3 font-black font-black font-black"><ShieldCheck size={28}/><span className="font-black uppercase">Canal Oficial Morumbis</span><StarRating /></div>
            <div className="flex flex-col items-center gap-3 font-black font-black font-black"><CheckCircle size={28}/><span className="font-black uppercase">Acesso Garantido</span><StarRating /></div>
            <div className="flex flex-col items-center gap-3 font-black font-black font-black"><Headphones size={28}/><span className="font-black uppercase">Suporte VIP Arena</span><StarRating /></div>
        </div>
      </section>
      ...
      <section id="sobre" className="py-24 px-6 bg-neutral-950 border-y border-neutral-900 text-center sm:text-left font-black italic font-black">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center font-black">
          <div className="font-black font-black font-black">
            ...
            <p className="text-gray-400 text-lg mb-12 font-normal leading-relaxed italic font-black font-black font-black font-black">Localizada no Morumbis, o Camarote Arena Henko oferece hospitalidade máxima e segurança total. Somos uma operação própria e oficial.</p>
          </div>
          <div className="grid gap-4">
             <div className="bg-neutral-900/40 p-10 rounded-[3rem] border border-neutral-800 flex gap-6 items-start shadow-xl group hover:border-red-600/50 transition-all font-black">
                <Shield className="text-red-600 w-10 h-10 shrink-0 font-black font-black font-black" />
                <div className="font-black font-black font-black"><h4 className="text-lg font-black uppercase italic text-white font-black font-black font-black font-black">Operação Oficial</h4><p className="text-gray-500 text-sm mt-2 font-normal italic font-black font-black font-black font-black">Tratativa direta com o camarote. Sem intermediários.</p></div>
             </div>
          </div>
        </div>
      </section>
            ...
            {SERVICES_DATA.map((service) => (
              <div key={service.id} className="group relative h-[400px] rounded-[3rem] overflow-hidden border border-white/5 bg-neutral-900 shadow-2xl transition-all hover:scale-[1.02] font-black">
                ...
                <div className="absolute bottom-10 left-10 right-10 text-left font-black">
                  <div className="bg-red-600 w-12 h-12 rounded-2xl flex items-center justify-center mb-6 shadow-xl font-black font-black">{service.icon}</div>
                  <h3 className="text-2xl font-black uppercase italic mb-2 font-black font-black">{service.title}</h3>
                  <p className="text-gray-400 text-sm font-normal font-black font-black">{service.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="reviews" className="py-24 bg-neutral-950 border-y border-white/5 font-black text-center italic">
        <div className="max-w-4xl mx-auto px-6 font-black font-black font-black">
          <Quote className="w-12 h-12 text-red-600 mx-auto mb-8 opacity-40 font-black font-black font-black font-black" />
          <div className="relative overflow-hidden h-48 md:h-40 font-black font-black font-black">
            {REVIEWS_DATA.map((review, i) => (
              <div key={i} className={`absolute inset-0 transition-all duration-700 ${currentReviewIndex === i ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <p className="text-xl md:text-2xl text-white italic mb-6 font-black font-black font-black font-black">"{review.text}"</p>
                <div className="flex justify-center mb-2 font-black font-black font-black font-black font-black"><StarRating /></div>
                <h4 className="text-red-600 uppercase text-xs tracking-widest font-black font-black font-black font-black">{review.name} — {review.role}</h4>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-5 gap-12 items-center font-black">
                <div className="lg:col-span-2 text-center font-black font-black font-black">
                    <div className="bg-black w-32 h-32 mx-auto rounded-3xl p-6 border border-neutral-800 flex items-center justify-center mb-6 overflow-hidden font-black font-black font-black">
                      <ImageWithFallback src={selectedSport.image} alt="League" className="max-h-full object-contain font-black font-black" />
                    </div>
                    <h3 className="text-4xl font-black uppercase italic font-black font-black font-black font-black">{selectedSport.name}</h3>
                </div>
                <div className="lg:col-span-3 space-y-4">
                    {visibleMatches.length > 0 ? visibleMatches.map((m) => (
                    <div key={m.id} className={`bg-neutral-950 border transition-all duration-300 rounded-[2.5rem] overflow-hidden ${expandedMatchKey === m.id ? 'border-red-600 shadow-2xl bg-neutral-900 font-black' : 'border-neutral-800 hover:border-neutral-700 font-black font-black font-black'}`}>
                        <button onClick={() => setExpandedMatchKey(expandedMatchKey === m.id ? null : m.id)} className="w-full p-8 flex flex-wrap md:flex-nowrap items-center justify-between gap-4 font-black font-black font-black font-black font-black">
                           <span className="text-red-600 text-base font-mono w-full md:w-auto text-left font-black font-black font-black font-black font-black">{m.date}</span> 
                           <div className="flex flex-1 items-center justify-center gap-6 font-black font-black font-black font-black">
                              <img src={m.homeLogo} className="w-12 h-12 object-contain font-black font-black font-black font-black font-black font-black" alt="" />
                              ...
                              <img src={m.awayLogo} className="w-12 h-12 object-contain font-black font-black font-black font-black font-black font-black" alt="" />
                           </div>
                        ...
                        <div className={`drawer-content ${expandedMatchKey === m.id ? 'drawer-open px-8 pb-8' : ''} font-black`}>
                             <div className="pt-4 border-t border-white/5 grid grid-cols-2 gap-4 text-left font-black font-black font-black">
                                <div className="font-black font-black"><p className="text-[10px] text-gray-500 uppercase tracking-widest font-black font-black font-black">Horário / Local</p><p className="text-sm font-black text-white font-black font-black">{m.time} • Estádio do Morumbis</p></div>
                                <div className="text-right font-black font-black"><p className="text-[10px] text-gray-500 uppercase tracking-widest font-black font-black font-black">Hospitalidade</p><p className="text-sm font-black text-emerald-500 uppercase font-black font-black font-black">Full Open Bar & Food</p></div>
                                <button onClick={() => window.open(getWaLink(`Interesse no jogo ${m.home} x ${m.away} (${m.date})`))} className="col-span-2 mt-4 bg-white/5 hover:bg-red-600 py-4 rounded-2xl flex items-center justify-center gap-3 transition-all font-black text-xs uppercase tracking-widest font-black font-black font-black"><Ticket size={16}/> Consultar Disponibilidade</button>
                             </div>
                        </div>
                    </div>
                    )) : <p className="text-center text-gray-700 py-16 uppercase text-[10px] font-black font-black font-black">Novas datas em breve.</p>}
                </div>
            </div>
        </div>
      </section>
            ...
            {SHOWS_DATA.map((show) => (
              <div key={show.id} className="group flex flex-col text-left font-black font-black">
                <div className="relative h-[450px] rounded-[3.5rem] overflow-hidden mb-8 border border-neutral-800 group-hover:border-red-600 transition-all duration-700 shadow-2xl bg-neutral-900 font-black font-black font-black">
                  <img src={show.image} className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 scale-105 group-hover:scale-110 font-black font-black font-black" alt={show.name} />
                </div>
                <span className="text-red-600 text-[11px] font-black uppercase tracking-[0.4em] mb-3 block font-black font-black italic font-black">{show.date}</span>
                <h3 className="text-4xl font-black uppercase mb-4 italic text-white leading-none font-black font-black font-black font-black">{show.name}</h3>
                <p className="text-gray-500 text-base font-normal mb-8 leading-relaxed italic font-black font-black font-black">{show.desc}</p>
                <button onClick={() => window.open(getWaLink(`Interesse oficial no evento ${show.name}.`))} className="text-[11px] font-black uppercase tracking-widest flex items-center gap-3 text-white hover:text-red-600 transition-colors font-black font-black font-black font-black font-black"><ArrowRight size={18} /> Ver Disponibilidade</button>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="galeria" className="py-24 px-6 bg-black border-y border-white/5 font-black text-center italic">
        <div className="max-w-7xl mx-auto font-black font-black font-black font-black">
          <div className="flex flex-col items-center justify-center mb-16 gap-4 font-black font-black font-black">
            <h2 className="text-4xl md:text-6xl font-black uppercase italic text-white font-black font-black font-black font-black">Nossa <span className="text-red-600 font-black font-black font-black">Galeria</span></h2>
            {isAlbumOpen && (
              <button onClick={() => setIsAlbumOpen(false)} className="mt-4 flex items-center gap-2 text-red-500 hover:text-white transition-colors uppercase text-[10px] font-black font-black font-black font-black">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-smooth font-black font-black font-black">
              {STATIC_GALLERY.map((album) => (
                <div key={album.id} onClick={() => { setActiveAlbumId(album.id); setIsAlbumOpen(true); }} className="group relative cursor-pointer overflow-hidden rounded-[3rem] aspect-[4/3] border border-white/10 bg-neutral-900 shadow-2xl font-black transition-transform hover:scale-[1.02] font-black font-black">
                  <img src={album.cover} className="absolute inset-0 w-full h-full object-cover opacity-60 transition-all duration-700 font-black font-black" alt={album.name} />
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-80 font-black font-black" />
                  <div className="absolute bottom-10 left-10 text-left font-black font-black font-black font-black">
                     <div className="bg-red-600 px-4 py-1 rounded-full text-[8px] w-fit mb-3 uppercase font-black italic font-black font-black">Pasta</div>
                     <h3 className="text-2xl italic uppercase font-black font-black font-black font-black font-black">{album.name}</h3>
                     <p className="text-gray-400 text-[10px] mt-1 uppercase font-black opacity-60 font-black font-black font-black font-black">{album.photos.length} Fotos</p>
                  </div>
                </div>
              ))}
            </div>
          ) : (
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 animate-smooth font-black font-black font-black font-black">
              {currentAlbum.photos.map((photoName, idx) => (
                <div key={idx} className="group relative aspect-square rounded-[2rem] overflow-hidden border border-white/5 bg-neutral-900 shadow-xl font-black font-black font-black">
                   <img 
                    ...
                    className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110 font-black font-black font-black" 
                    alt={`Foto ${idx}`} 
                   ...
                   <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center font-black font-black font-black">
                     <button className="bg-white/10 backdrop-blur-md p-4 rounded-2xl text-white font-black font-black font-black font-black font-black font-black"><Download size={24} /></button>
                   </div>
                </div>
              ))}
            </div>
      ...
      {isLoginModalOpen && (
        <div className="fixed inset-0 z-[300] bg-black/95 backdrop-blur-2xl flex items-center justify-center p-8 font-black font-black font-black font-black font-black">
          <div className="bg-neutral-900 border border-neutral-800 p-16 rounded-[4rem] w-full max-w-md shadow-3xl text-center">
            <h2 className="text-2xl uppercase mb-8 italic text-white font-black font-black font-black font-black font-black font-black font-black font-black">Painel <span className="text-red-600 font-black font-black font-black font-black font-black">Admin</span></h2>
            <form onSubmit={handleAdminLogin}>
              <input type="password" placeholder="Senha" value={adminInputPass} onChange={(e) => setAdminInputPass(e.target.value)} className="w-full bg-black border border-neutral-800 rounded-3xl px-10 py-6 mb-8 text-white focus:outline-none focus:border-red-600 text-center tracking-widest font-black font-black font-black font-black font-black font-black font-black font-black font-black" />
              <div className="flex gap-6 font-black font-black font-black font-black font-black font-black">
                ...
                <button type="submit" className="flex-1 py-5 text-[11px] uppercase bg-red-600 rounded-2xl text-white font-black font-black font-black font-black font-black font-black font-black">Entrar</button>
              </div>
            </form>
          </div>
        </div>
