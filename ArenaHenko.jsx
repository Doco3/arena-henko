  ...
  const renderHome = () => (
    <>
      ...
      <section id="contato" className="py-40 bg-neutral-950 px-6 relative overflow-hidden text-white border-t border-neutral-900 text-center font-bold font-black">
        <div className="max-w-4xl mx-auto relative z-10 text-white font-bold font-black">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20 text-white font-bold font-black">
             <a href="https://instagram.com/arenahenko" target="_blank" rel="noreferrer" className="flex flex-col items-center p-10 bg-neutral-900/50 rounded-3xl border border-neutral-800 hover:border-red-600 group shadow-xl transition-all font-bold"><Instagram className="w-10 h-10 text-red-600 mb-6 group-hover:scale-110 transition-transform font-bold font-black" /><span className="font-bold text-[11px] uppercase tracking-[0.2em] font-bold font-black">Instagram</span></a>
             <a href="https://wa.me/5511940741355" target="_blank" rel="noreferrer" className="flex flex-col items-center p-10 bg-neutral-900/50 rounded-3xl border border-neutral-800 hover:border-red-600 group shadow-xl transition-all text-white font-bold font-black"><Phone className="w-10 h-10 text-red-600 mb-6 group-hover:scale-110 transition-transform text-red-600 font-bold font-black" /><span className="font-bold text-[11px] uppercase tracking-[0.2em] font-bold font-black">WhatsApp</span></a>
             <a href="mailto:sergio@henkoproducoes.com.br" className="flex flex-col items-center p-10 bg-neutral-900/50 rounded-3xl border border-neutral-800 hover:border-red-600 group shadow-xl transition-all text-white font-bold font-black"><Mail className="w-10 h-10 text-red-600 mb-6 group-hover:scale-110 transition-transform text-red-600 font-bold font-black" /><span className="font-bold text-[11px] uppercase tracking-[0.2em] font-bold font-black">E-mail</span></a>
          </div>
        </div>
      </section>
    </>
