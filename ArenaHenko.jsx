...
const App = () => {
  ...
  return (
    <div className="font-sans text-gray-100 bg-neutral-950 min-h-screen text-center overflow-x-hidden selection:bg-red-600">
            ...
            {services.map((s, i) => (
              <div key={i} className="group relative h-[450px] rounded-[50px] overflow-hidden border border-white/5 hover:border-red-600/50 transition-all shadow-3xl">
                ...
                <div className="relative z-20 h-full p-10 flex flex-col justify-end">
                  ...
                  <h3 className="text-2xl font-black text-white uppercase mb-3 tracking-tighter leading-none">{s.title}</h3>
      ...
      <footer className="py-24 border-t border-neutral-900 opacity-40 text-white text-white text-center"><p className="text-[11px] font-bold uppercase tracking-[0.5em] text-white">© 2026 ARENA HENKO. TODOS OS DIREITOS RESERVADOS.</p></footer>
    </div>
  );
};
export default App;
